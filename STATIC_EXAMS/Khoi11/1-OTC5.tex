\section{Ôn tập chương 5 - Giới hạn - Hàm số liên tục}
...
Ta có $p=3$; $a_3=12$; $m_3=30$; $m_1+m_2=27$; $a_4-a_3=2$ khi đó trung vị của mẫu số liệu là
...
\end{center}
 ...
 Mốt của mẫu số liệu là $M_o=8+\dfrac{10-7}{10-7+10-5}(9-8)=8{,}375$.
	\end{itemchoice}
}
\end{ex}
...
\end{tabular}
\end{center}
Cân nặng trung bình của học sinh là $$\overline{x}=\dfrac{43\cdot 10+48\cdot 7+53\cdot 16+58\cdot 4+63\cdot 2+68\cdot 3}{42}=51{,}81.$$
}
\end{ex}
...
\end{tabular}
\end{center}
Chiều cao trung bình của học sinh $11 \mathrm{C} 1$ là bao nhiêu? (Kết quả làm tròn đến hàng đơn vị).
\shortans{$161$}
	\loigiai{
\begin{center}
\begin{tabular}{|l|c|c|c|c|c|}
...
$$\overline{x}=\dfrac{1}{45}(7\cdot 152{,}5+15\cdot 157{,}5+12\cdot 162{,}5+4 \cdot 167{,}5+3\cdot 172{,}5)=160{,}8\approx 161 \mathrm{~cm}.$$
}
\end{ex}
...
\end{tabular}
\end{center}
Công ty bất động sản Đất Vàng nên xây nhà ở mức giá nào để nhiều người có nhu cầu xây nhà? (Kết quả làm tròn đến hàng phần chục).
\shortans{$19{,}9$}
	\loigiai{
