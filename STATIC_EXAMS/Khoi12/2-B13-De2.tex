...
\caulc
%cau1
\begin{ex}%[ST12-dot1-Trần xuân Hòa]%[2D4N3-1]
...
\end{ex}
%cau2
\begin{ex}%[ST12-dot1-Trần xuân Hòa]%[2D4N3-3]
...
\end{ex}
%cau5
\begin{ex}%[ST12-dot1-Trần xuân Hòa]%[2D4N3-4]
...
\end{ex}
%cau6
\begin{ex}%[ST12-dot1-Trần xuân Hòa]%[2D4H3-4]
...
\end{ex}
%cau12
\begin{ex}%[ST12-dot1-Trần xuân Hòa]%[2D4V3-3]
...
\begin{ex}%[ST12-dot1-Trần xuân Hòa]%[2D4V3-1]
	...
	\begin{center}
		\begin{tikzpicture}[>=stealth,line join=round,line cap=round,font=\footnotesize,scale=1]
			...
			\fill (0,0)node[below left]{$O$}circle(1.5pt) (-3,0)node[above]{$E$}circle(1.5pt) (-2,4/3)node[above left]{$G$}circle(1.5pt) (0,4)node[above right]{$D$}circle(1.5pt) (1,3)node[above]{$C$}circle(1.5pt) (2,4)node[above]{$A$}circle(1.5pt) (3,3)node[above right]{$H$}circle(1.5pt) (4,0)node[above right]{$B$}circle(1.5pt);
		\end{tikzpicture}
	\end{center}
	\choiceTF
...
\begin{ex}%[ST12-dot1-Trần xuân Hòa]%[2D4V3-1]
	...
	{\begin{tikzpicture}[scale=0.9,thick,>=stealth,x=0.9cm,
			y=0.9cm]
			\draw[thin,->](-2.2,0)--(3.0,0) node[below]{$x$};
			\draw[thin,->](0,-2.0)--(0,3.0) node[left]{$y$};
...
\end{ex}
\begin{ex}%[ST12-dot1-Trần xuân Hòa]%[2D4V3-3]
	\immini{Cho đồ thị $(C)\colon y=f(x)=\sqrt{x}$. Gọi $(H)$ là hình phẳng giới hạn bởi $(C)$, đường thẳng $x=9$, trục hoành. Cho $M$ là điểm thuộc $(C)$, $A(9;0)$. Gọi $V_1$ là thể tích khối tròn xoay khi cho $(H)$ quay quanh trục $Ox$, $V_2$ là thể tích khối tròn xoay khi cho tam giác $AOM$ quay quanh trục $Ox$.
	}
...
\caukq
\begin{ex}%[ST12-dot1-Trần xuân Hòa]%[2D4H3-3]
