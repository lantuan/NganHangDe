...
\lstset{basicstyle=\ttfamily\footnotesize, frame=single, breaklines=true,
        columns=fullflexible, showstringspaces=false, xleftmargin=0.5cm,
        framexleftmargin=0.5cm, aboveskip=10pt, belowskip=10pt}
\usepackage{titlesec}
...
\input{noidung/00_bia}
\input{noidung/01_don_yeu_cau}

\clearpage
\tableofcontents
\clearpage

\input{noidung/02_mo_dau}
\input{noidung/03_co_so_ly_luan}
\input{noidung/04_thuc_trang}
\input{noidung/05_giai_phap}
\input{noidung/06_huong_dan}
\input{noidung/07_hieu_qua}
\input{noidung/08_huong_phat_trien}
\input{noidung/09_ket_luan}
