...
\end{tabular}
\end{center}
\textit{Bảng 8. Hiệu quả về thời gian làm việc của giáo viên}
...
\end{tabular}
\end{center}
\textit{Bảng 9. Kết quả khảo sát học sinh sau khi áp dụng (tổng số: \dots\ học sinh)}
...
\end{tabular}
\end{center}
\textit{Bảng 10. So sánh kết quả bài kiểm tra giữa lớp thực nghiệm và lớp đối chứng}

\ghichu{Bảng 10 là bảng hội đồng chấm đọc kĩ nhất. Lưu ý ba điều: (1) hai lớp
...
\end{tabular}
\end{center}
\textit{Bảng 11. Số liệu vận hành thực tế của hệ thống}
