...
\begin{enumerate}[label=(\arabic*), leftmargin=1.2cm, itemsep=3pt]
  ...
  \item \textbf{Về mặt sản phẩm:} hệ thống đang chạy thật tại địa chỉ
        ...
        điểm Google Classroom và bảng thống kê của giáo viên. Toàn bộ mã nguồn
        được công khai tại \url{https://github.com/lantuan/NganHangDe} để hội
        đồng và đồng nghiệp kiểm chứng.
...
\textbf{Phụ lục 6.} Mã nguồn công khai của hệ thống, kèm toàn bộ tài liệu kĩ
thuật và nhật kí các lần cải tiến: \url{https://github.com/lantuan/NganHangDe}
