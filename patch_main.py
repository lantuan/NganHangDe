...
old_block = '''from fastapi import FastAPI
...
assert content.count(old_block) == 1, "Khong tim thay noi dung goc main.py."

new_block = '''from fastapi import FastAPI, Request
from fastapi.staticfiles import StaticFiles
