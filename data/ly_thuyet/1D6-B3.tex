...
\begin{dang}{Đồ thị hàm số}
	Để vẽ đồ thị hàm mũ $y=a^x$ hoặc hàm lôgarit $y=\log_a x$, ta làm như sau:
	\begin{listEX}[1]
...
\begin{vd}
	...
	\begin{center}
		\includegraphics[scale=0.35]{h1.jpg}
	\end{center}
...
\begin{baitap}
	...
	\begin{center}
		\includegraphics[scale=0.25]{h2.jpg}
	\end{center}
