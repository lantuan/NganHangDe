...
\begin{baitap}%[Đỗ Vũ Minh Thắng]%[1D5B5] 
	Tìm đạo hàm cấp hai của các hàm số sau:
	\begin{tasks}(2)
...
\begin{baitap}%[Ngô Quang Anh]%[1D5Y5]
...
\begin{baitap}%[Ngô Quang Anh]%[1D5B5]
...
\end{baitap}
\begin{baitap}%[Ngô Quang Anh]%[1D5K5]
