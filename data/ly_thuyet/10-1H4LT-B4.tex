...
\begin{itemize}
	\item [\iconCH] \indamm{Trường hợp 1:} $(P)$ và $(Q)$ trùng nhau.
	\item [\iconCH] \indamm{Trường hợp 2:} $(P)$ và $(Q)$ có một điểm chung. Khi đó chúng sẽ có điểm chung khác nữa. Tập hợp tất cả các điểm chung đó gọi là  giao tuyến của hai mặt phẳng $(P)$ và $(Q)$ (\textbf{Hình 1}).
	\item [\iconCH] \indamm{Trường hợp 3:} $(P)$ và $(Q)$ không có điểm chung. Khi đó ta nói $(P)$ song song $(Q)$ (\textbf{Hình 2}).
	\begin{itemize}
...
\iconMT\,\indam{Định lý 4:} (\textit{Định lí Thales}) Ba mặt phẳng đôi một song song chắn trên hai cát tuyến bất kì những đoạn thẳng tương ứng tỉ lệ.\\
\hspace*{2cm}
\begin{tikzpicture}[line join = round, line cap = round,>=stealth,font=\footnotesize,scale=0.7]
