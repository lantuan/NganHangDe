...
\begin{dang}{Tìm tiệm cận đứng và tiệm cận ngang của đồ thị hàm số}
	...
	\begin{enumerate}[\iconCH]
		...
		\begin{listEX}[1]
			...
			\item [\ding{173}] Xem ở "vị trí" nào ra kết quả hữu hạn thì ta kết luận có tiệm cận ngang ở "vị trí" đó.
		\end{listEX}
		\ind{Lưu ý:} Đồ thị hàm số $y=\dfrac{ax+b}{cx+d}$ luôn có TCĐ $x=-\dfrac{d}{c}$ và TCN: $y=\dfrac{a}{c}$.
	\end{enumerate}
\end{dang}
...
\begin{vd}
	...
	\begin{enumEX}[a)]{3}
		...
		\item $y=\dfrac{\sqrt{x^2+3x}}{x-1}$
		\item $y=\dfrac{4x-1}{\sqrt{x^2-3x}}$
	\end{enumEX}
\loigiai{
\begin{enumerate}[a)]
...
\begin{ex}
	Cho hàm $y=\dfrac{5 - 6 x}{6 x + 1}$. Xét tính đúng-sai của các khẳng định sau
	\choiceTF
	{ $\mathop{\lim}\limits_{x \to  - \frac{1}{6}^-} {y}=+\infty$  }
	{ \True $\mathop{\lim}\limits_{x \to  +\infty} {y}=-1$ }
	{ $x=\dfrac{1}{6}$ là đường tiệm cận đứng}
	{ \True $y=-1$ là đường tiệm cận ngang}
	\loigiai{ 
		
		
		a) Khẳng định đã cho là khẳng định sai.
		
		Ta có: $\mathop{\lim}\limits_{x \to  - \frac{1}{6}^-} {y}=-\infty$, $\mathop{\lim}\limits_{x \to  - \frac{1}{6}^+} {y}=+\infty$
		...
		$\mathop{\lim}\limits_{x \to  - \frac{1}{6}^+}y=+\infty$ nên đồ thị hàm số có tiệm cận đứng là $x=- \frac{1}{6}$.
		
		d) Khẳng định đã cho là khẳng định đúng.
		
		$\mathop{\lim}\limits_{x \to  +\infty} {y}=-1$ nên đồ thị hàm số có tiệm cận ngang là $y=-1$.
...
\begin{ex}
	...
	\begin{center}
		\begin{tikzpicture}
			\tikzset{double style/.append style = {draw=\tkzTabDefaultWritingColor,double=\tkzTabDefaultBackgroundColor,double distance=2pt}}
			\tkzTab[nocadre=false,lgt=1.2,espcl=2.3,deltacl=0.6]
			{$x$/0.6, $y'$/0.6, $y$/2}
			{$-\infty$, $0$, $2$, $+\infty$}
			{,-,d,-,$0$,+,}
			{+/ $2$, -D+/ $-\infty$ / $+\infty$, -/ $2$,+/$+\infty$}
		\end{tikzpicture}
	\end{center}Xét tính đúng, sai của các khẳng định sau:
		\choiceTF
		{\True $f(-5)<f(4)$}
...
\begin{ex}
	Cho hàm số $y=f(x)$ có bảng biến thiên như hình vẽ. Xét tính đúng-sai của các khẳng định sau.
	\begin{center}
		\begin{tikzpicture}
			\tikzset{double style/.append style = {draw=\tkzTabDefaultWritingColor,double=\tkzTabDefaultBackgroundColor,double distance=2pt}}
			...
			{$-\infty$,$-2$,$-1$,$+\infty$}
			\tkzTabLine{,-,d,-,0,+,}
			\tkzTabVar{+/ $10$ ,-D+/ $-\infty$ / $7$,-/ $5$, +/ $9$}
		\end{tikzpicture}
	\end{center}
	\choiceTF
	{ \True Đồ thị hàm số $y=f(x)$ có tiệm cận đứng là $x=-2$}
	{ Đồ thị hàm số $y=f(x)$ nhận đường thẳng $y=5$ làm một tiệm cận ngang}
	{ Đồ thị hàm số $y=f(x)$ có đúng bốn đường tiệm cận}
	{ Đồ thị hàm số $y=\dfrac{ 4 }{f(x)-6}$ có đúng một đường tiệm cận đứng}
	\loigiai{ 
		
		
		a) Khẳng định đã cho là khẳng định đúng.
		
		$\mathop{\lim}\limits_{x \to  -2^-} {f(x)}=-\infty$ nên $x=-2$ là tiệm cận đứng của đồ thị hàm số $y=f(x)$.
		
		b) Khẳng định đã cho là khẳng định sai.
		
		$\mathop{\lim}\limits_{x \to  -\infty} {f(x)}=10, \mathop{\lim}\limits_{x \to  -\infty} {f(x)}=9$
		
		nên đồ thị hàm số $y=f(x)$ có các tiệm cận ngang là $y=10$ và $y=9$.
		
		c) Khẳng định đã cho là khẳng định sai.
		
		Đồ thị hàm số $y=f(x)$ có tiệm cận đứng là $x=-2$ và hai tiệm cận ngang là $y=10, y=9$.
		
		d) Khẳng định đã cho là khẳng định sai.
		
		$f(x)-6=0 \Leftrightarrow x=a<-2,x=b\in (-2;-1),x=c>-1$.
		
		Khi $x \to a$ hoặc $x \to b$ hoặc $x \to c$ thì $y=\dfrac{ 4 }{f(x)-6} \to \infty$.
		
		Vậy đồ thị hàm số $y=\dfrac{ 4 }{f(x)-6}$ có 3 đường tiệm cận đứng.
...
\begin{dang}{Tìm tiệm cận đứng và tiệm cận xiên của đồ thị hàm số}
	\begin{enumerate}[\iconCH]
		...
		\begin{listEX}[1]
			...
			\item [\ding{173}] Đường thẳng $y=ax+b$, với $a \ne 0$ có đúng một đường tiệm cận xiên là chính nó.
			\item [\ding{174}] Đối với hàm số phân thức $f(x)=\dfrac{ax^2+bx+c}{mx+n}$, ta có thể chia đa thức, biến đổi về dạng
...
\begin{ex}
	Cho hàm số $y=f(x)$ có đường tiệm cận xiên là $y=2 - 2 x$. Tìm khẳng định đúng?\\ 
	\choice
	{ $\mathop{\lim}\limits_{x \to  -2} {[f(x) - 2 x + 2]}=-\infty$ }
	{ $\mathop{\lim}\limits_{x \to  -\infty} {[f(x) + 2 x - 2]}=-2$ }
	{ $\mathop{\lim}\limits_{x \to  +\infty} {[f(x) + 2 x - 2]}=-2$ }
	{ \True $\mathop{\lim}\limits_{x \to  +\infty} {[f(x) + 2 x - 2]}=0$ }
	\loigiai{ 
		
}\end{ex}
\cham{2}
\begin{ex}
	Cho hàm số $y=f(x)$ có $\mathop{\lim}\limits_{x \to  +\infty} {[f(x) + x + 4]}=0$. Tìm khẳng định đúng.
	\choice
	{ \True Đường tiệm cận xiên của đồ thị hàm số $y=f(x)$ là $y=- x - 4$ }
	{ Đường tiệm cận ngang của đồ thị hàm số $y=f(x)$ là $y=-4$ }
	{ Đường tiệm cận xiên của đồ thị hàm số $y=f(x)$ là $y=4 - x$ }
	{ Đường tiệm cận đứng của đồ thị hàm số $y=f(x)$ là $x=-1$ }
	\loigiai{ 
...
\cham{4}
\begin{ex}
	Giao điểm của đường tiệm cận đứng và đường tiệm cận xiên của đồ thị hàm số $y=\dfrac{2x^2-3x+2}{x-1}$ có tọa độ là
	\choice
	{$(1;2)$}
	{\True $(1;1)$}
	{$(1;-1)$}
...
\cham{5}
\begin{ex}
	Giao điểm của đường tiệm cận đứng và đường tiệm cận xiên của đồ thị hàm số $y=\dfrac{- 2 x^{2} - 2 x - 1}{x - 4}$ có tọa độ là
	\choice
	{ $\left(-4;\dfrac{25}{8}\right)$ }
	{ $\left(2;-18\right)$ }
	{ $\left(4;-22\right)$ }
	{ \True $\left(4;-18\right)$ }
	\loigiai{ 
		$y=\frac{- 2 x^{2} - 2 x - 1}{x - 4}=- 2 x - 10 - \frac{41}{x - 4}$.
		
		Đồ thị hàm số có tiệm cận đứng là đường thẳng $x=4$.
		
		Đồ thị hàm số có tiệm cận xiên là đường thẳng $y=- 2 x - 10$.
		
		Suy ra, giao điểm là  $\left(4;-18\right)$.
