\begin{dang}{Đồ thị hàm số phân thức hữu tỉ $y=\dfrac{ax^2+bx+c}{mx+n}$}
	\begin{itemize}
		...
		\begin{itemize}
			\item Tính đạo hàm $y'=\dfrac{am\cdot x^2+2an\cdot x + b.n - m.c}{(mx+n)^2}$;\\
			 Giải $y'=0 \Leftrightarrow am\cdot x^2+2an\cdot x + b.n - m.c=0$, tìm nghiệm.
		...
		\end{itemize}
		\item [\iconCH] \indamm{Bước 3.} Vẽ tiệm cận đứng và tiệm cận xiên; Cho thêm điểm và vẽ đồ thị của hàm số dựa vào bảng biến thiên.
	\end{itemize}
\end{dang}
