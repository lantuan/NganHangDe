...
Trong không gian $Oxyz$:
	\immini{
		\begin{boxkn}
		\begin{itemize}
			\item Toạ độ của điểm $M$ là toạ độ của vectơ $\overrightarrow{OM}$.
			\item Cho $\vec{u}$. Dựng điểm $M(a;b;c)$ thỏa $\vec{OM}=\vec{u}$ thì tọa độ của điểm $M$ là tọa độ của $\vec{u}$. Ta có
...
\begin{dang}{Tọa độ điểm, tọa độ vec tơ}
	...
	\begin{listEX}[2]
		...
		\item [\ding{173}] $\vec{u}=\vec{v} \Leftrightarrow \heva{&u_1=v_1\\&u_2=v_2\\&u_3=v_3}$
...
\end{ex} \cham{3}
\begin{ex}
	\immini[thm]{Trong không gian $Oxyz$, cho hình hộp $ABCD.A'B'C'D'$, biết rằng $A(-3;0;0)$, $B(0;2;0)$, $D(0;0;1)$, $A'(1;2;3)$. Tìm tọa độ điểm $C'$.
	\choice
	{$(-13;4;4)$}
	{$(13;4;4)$}
	{\True $(7;4;4)$}
...
\end{tikzpicture}}
	\loigiai{
		...
		Mà $\overrightarrow{AC'}=\overrightarrow{AB}+\overrightarrow{AD}+\overrightarrow{AA'}=(10;4;4)\Rightarrow \heva{&x=7\\&y=4\\&z=4.}$
	}
\end{ex}
\cham{3}
\begin{ex}
	\immini[thm]{Trong không gian $Oxyz$, cho hình hộp $ABCD.A'B'C'D'$ với các đỉnh $A(-1;1;2)$, $B(-3;2;1)$, $D(0;-1;2)$, $A'(2;1;2)$. Tìm tọa độ đỉnh $C'$.
	\choice
	{$C'(-3;1;3)$}
	{$C'(0;1;0)$}
	{\True $C'(1;0;1)$}
...
\end{tikzpicture}}
	\loigiai{
		...
		$$\begin{aligned}
			...
			& \Leftrightarrow (x+1;y-1;z-2)=(3;0;0)+(-2;1;-1)+(1;-2;0)\\
			&\Leftrightarrow (x+1;y-1;z-2)=(2;-1;-1)\\
			&\Leftrightarrow\heva{&x+1=2\\&y-1=-1\\&x-2=-1}\Leftrightarrow\heva{&x=1\\&y=0\\&z=1.}
		\end{aligned}$$
	}
\end{ex}
\cham{2}
\begin{ex}
	\immini[thm]{Trong không gian $Oxyz$, cho hình hộp $ABCD.A’B’C’D’$ biết $A(1;2;3)$, $B’(2;0;-1)$, $C(3;0;-3)$ và $D’(-2;4;-3)$. Tọa độ đỉnh $B$ của hình hộp $ABCD.A’B’C’D’$ là
	\choice
	{\True $B(4;-1;1)$}
	{$B(2;-1;2)$}
	{$B(0;1;-3)$}
...
\end{tikzpicture}}
	\loigiai{
		\immini{
			...
			Ta có $I(2;1;0)$, $I’(0;2;-2)$ và $\overrightarrow{II’}=(-2;1;-2)$.\\
			Giả sử $B(a;b;c) \Rightarrow \overrightarrow{BB'}=(2-a;-b;-1-c)$.\\
			Theo tính chất của hình hộp ta có $$\overrightarrow{II’}=\overrightarrow{BB'} \Leftrightarrow \heva{& 2-a=-2 \\& -b=1 \\&-1-c=-2 }\Leftrightarrow \heva{& a=4 \\& b=-1 \\& c=1. }$$
			Vậy B$(4;-1;1)$.
		}
		{
			\begin{tikzpicture}[line join = round, line cap = round,>=stealth,font=\footnotesize,scale=.7]
				...
				\tkzGetPoint{I'}
				\tkzDrawPolygon(A,B,B',C',D',D)
				\tkzDrawSegments(C,B C,C' C,D A,C B,D)
				\tkzDrawSegments[dashed](A',A A',B' A',D' A',C' I,I' B',D')
...
\end{ex} \cham{1}
\begin{ex}
	\immini{Trong không gian $Oxyz$, cho $\vec{a}=(2;0;2)$, $\vec{b}=2\vec{j}+2\vec{k}$. Dựng $\vec{OA}=\vec{a}$ và $\vec{OB}=\vec{b}$.
		\choiceTF
...
\begin{vd}%[2H2H2-6]
	Cho tứ diện $OABC$ có $OA$, $OB$, $OC$ đôi một vuông góc với nhau và $OA=4$, $OB=6$, $OC=8$.
	\begin{enumerate}
		\item  Xác định một hệ toạ độ với $O$ là gốc tọa độ và các vectơ đơn vị $\overrightarrow{i}$, $\overrightarrow{j}$, $\overrightarrow{k}$ theo thứ tự cùng hướng với $\overrightarrow{OA}$, $\overrightarrow{OB}$, $\overrightarrow{OC}$.
		\item  Trong hệ toạ độ thiết lập ở câu a), tìm toạ độ các điểm $A$, $B$, $C$ và điểm $M$ là trung điểm của $AB$.
	\end{enumerate}
	\loigiai{
		\begin{center}
			\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round, >=stealth]
				...
				\coordinate[label=above left:$O$] (O) at (\gocB:\ba);
				\coordinate[label=below:$A$] (A) at ($(O)+(0:\bc)$);
				\coordinate[label=right:$C$] (C) at ($(O)+(90:\h)$);
				\coordinate[label=right:$z$] (z) at ($(C)+(90:\l)$);
				\coordinate[label=above:$x$] (x) at ($(A)+(0:\l)$);
				\coordinate[label=left:$y$] (y) at ($(B)-(\gocB:\l)$);
				\coordinate[label=right:$\overrightarrow{k}$] (k) at ($(O)+(90:\l)$);
				\coordinate[label=above:$\overrightarrow{i}$] (i) at ($(O)+(0:\l)$);
				\coordinate[label=left:$\overrightarrow{j}$] (j) at ($(O)-(\gocB:\l)$);
				\coordinate[label=below:$M$] (M) at ($(A)!0.5!(B)$);
				\draw[dashed] (B)--(O)--(C) (O)--(A);
				\draw (C)--(A)--(B)--cycle;
				\draw[->] (C)--(z);
				\draw[->] (B)--(y);
				\draw[->] (A)--(x);
				\draw[->,line width=2] (O)--(i);
				\draw[->,line width=2] (O)--(j);
				\draw[->,line width=2] (O)--(k);
				\foreach \diem in {A,B,O,M,C}	\fill (\diem)circle(1pt);
		...
		\end{center}
		\begin{enumerate}
			\item  Ta thiết lập một hệ tọa độ $Oxyz$ với $\overrightarrow{i}=\dfrac{1}{4} \overrightarrow{OA}$; $\overrightarrow{j}=\dfrac{1}{6} \overrightarrow{OB};\overrightarrow{k}=\dfrac{1}{8} \overrightarrow{OC}$.
			\item  Trong hệ toạ độ vừa chọn, ta có
			\begin{align*}
				&\overrightarrow{OA}=4\overrightarrow{i}+0\overrightarrow{j}+0 \overrightarrow{k};\overrightarrow{OB}=0\overrightarrow{i}+6 \overrightarrow{j}+0\overrightarrow{k}\\
				&\overrightarrow{OC}=0\overrightarrow{i}+0\overrightarrow{j}+8 \overrightarrow{k};\\
				&\overrightarrow{OM}=\dfrac{1}{2}\Big(\overrightarrow{OA}+\overrightarrow{OB}\Big)=2\overrightarrow{i}+3\overrightarrow{j}+0\overrightarrow{k}.
			\end{align*}
			Suy ra $A(4;0;0)$, $B(0;6;0)$, $C(0;0;8)$, $M(2;3;0)$.
		\end{enumerate}
	}
\end{vd}
\dongcham{7}
\begin{vd}
	\immini{Cho hình hộp chữ nhật $ABCD.A'B'C'D'$ có cạnh $AB=AA'=2$, $AD=4$. Gọi $E$ là tâm của hình chữ nhật $ABCD$, $F$ là trung điểm $AC'$. Với hệ toạ độ $Oxyz$ được thiết lập như hình bên (gốc tọa độ $O$ trùng với $A$), hãy xác định tọa độ các đỉnh của hình hộp chữ nhật và tọa độ hai điểm $E$, $F$.
		...
		\begin{tikzpicture}[scale=0.7, font=\footnotesize,>=stealth]
			...
			\foreach \x/\g in {A/-90,B/180,C/-70,D/40,A'/40,B'/180,C'/10,D'/0,E/-90,F/-10}\draw[fill=black] (\x) circle (.04) +(\g:.5)node{\footnotesize$\x$};
	\end{tikzpicture}}
	\loigiai{}
\end{vd}
\dongcham{10}
...
\begin{vd}%[2H2V2-6]
	Một người đứng ở mặt đất điều khiển hai flycam để phục vụ trong một chương trình của đài truyền hình. Flycam I ở vị trí $A$ cách vị trí điều khiển $130$ m về phía nam và $170$ m về phía đông, đồng thời cách mặt đất $55$ m. Flycam II ở vị trí $B$ cách vị trí điều khiển $170$ m về phía bắc và $216$ m về phía tây, đồng thời cách mặt đất $60$ m. Chọn hệ trục tọa độ $Oxyz$ với gốc $O$ là vị trí người điều khiển, mặt phẳng $(Oxy)$ trùng với mặt đất, trục $Ox$ có hướng trùng với hướng nam, trục $Oy$ trùng với hướng đông, trục $Oz$ vuông góc với mặt đất hướng lên bầu trời, đơn vị trên mỗi trục tính theo mét. Khoảng cách giữa hai flycam (làm tròn đến hàng đơn vị của mét) bằng bao nhiêu?
	\loigiai{
		Theo cách đặt hệ trục tọa độ trong đề bài, ta có tọa độ điểm $A(130; 170; 55)$ và tọa độ điểm $B(-170; -216; 60)$. Khi đó khoảng cách giữa hai flycam chính là độ dài đoạn $AB$.\\
		Ta có $\vec{AB}=(-300; -386; 5)$. Suy ra
		$$AB=|\vec{AB}|=\sqrt{(-300)^2+(-386)^2+5^2}=\sqrt{239021}\approx 489.$$
		Vậy khoảng cách giữa hai flycam đó bằng $489$ m.
	}
\end{vd}
\dongcham{11}
\begin{vd}%[2H2V2-2]
...
\dongcham{12}
\begin{vd}%[2H2H2-6]
	\immini{Một chiếc xe đang kéo căng sợi dây cáp $AB$ trong công trường xây dựng, trên đó đã thiết lập hệ toạ độ $Oxyz$ như hình bên với độ dài đơn vị trên các trục toạ độ bằng $1$(m). Tìm toạ độ của véc-tơ $\overrightarrow{AB}$.
	}{
		\includegraphics[scale=0.4]{images/H6}
	}
	\loigiai{
	
			$\triangle OBH$ vuông tại $H$, có $\widehat{HOB}= 30^\circ$,\\
			$OB = 15\Rightarrow OH = OB\cdot \cos 30 = \dfrac{15\sqrt{3}}{2}$,\\
			$ BH = OB\cdot \sin 30 = \dfrac{15}{2} \Rightarrow OK = \dfrac{15}{2}$.\\
			Ta có $\overrightarrow{OA} = 10\overrightarrow{k} $, $\overrightarrow{OH} = \dfrac{15\sqrt{3}}{2} \overrightarrow{j}$, $\overrightarrow{OK} = \dfrac{15}{2}\overrightarrow{i}$.\\
			Khi đó 
			\begin{eqnarray*}
				\overrightarrow{AB} & = &\overrightarrow{OB} - \overrightarrow{OA} = \overrightarrow{OH}+\overrightarrow{OK}-\overrightarrow{OA}\\
				& = & \dfrac{15}{2}\overrightarrow{i} + \dfrac{15\sqrt{3}}{2} \overrightarrow{j} - 10 \overrightarrow{k}\\
				\Rightarrow \overrightarrow{AB} & =&  \left(\dfrac{15}{2}; \dfrac{15\sqrt{3}}{2}; - 10 \right).
			\end{eqnarray*}
	}
\end{vd}
...
\begin{ex}%[2H2H2-2]
	\immini[thm]{
		...
		\begin{tikzpicture}[scale=1, font=\footnotesize, line join=round, line cap=round, >=Stealth]
			...
			;
			\foreach \x/\g in {B/-90,x/90,y/180,z/0,C/-90,A/210,S/90}
			\draw[fill=black] 	(\x)
			($(\g:.2)+(\x)$) node {$\x$};	
		\end{tikzpicture}
	}
...
\begin{ex}%[2H5V2-8]
	\immini{Một tháp phát sóng cao $50$ m đặt ở góc $A$ của sân hình chữ nhật $ABCD$. Để giữ cho tháp không bị đổ, người ta có cột rất nhiều dây cáp quanh tháp và cố định tại các vị trí trên mặt đất. Hai chú kiến vàng và kiến đen bắt đầu leo lên hai dây cáp $CM$ và $BN$ (từ $C$ và $B$) với vận tốc lần lượt là $3$ m/phút và $2{,}5$ m/phút (được mô hình hóa trong hệ trục tọa độ $Axyz$ như hình vẽ bên). Xét trong thời gian $10$ phút.}{
		\begin{tikzpicture}[thick, font = \footnotesize, scale =1,>=stealth]
			\path
			(0,0) coordinate (A)++(0:4) coordinate (D)
			(A)++(0:-2) coordinate (B')
			(A)++(90:3.5) coordinate (Cz)
			(A)++(-140:2) coordinate (B)
			($(B)+(D)-(A)$) coordinate (C)
			($(A)!0.6!(Cz)$)  coordinate (N)
			($(A)!0.8!(Cz)$)  coordinate (M)
			($(A)!0.99!(Cz)$)  coordinate (t)
			($(B)!0.4!(N)$)  coordinate (P)
			($(C)!0.7!(M)$)  coordinate (K)
			($(A)!1.3!(B)$) coordinate (x) node[below]{$x$}
			($(A)!1.2!(D)$) coordinate (y) node[below]{$y$}
			($(A)!1.3!(Cz)$) coordinate (z) node[right]{$z$};
			\draw (A)--(B) (A)--(D) (A)--(Cz) 
			(B)--(C)--(D)
			(B)--(N) (C)--(M)
			(P)--(K)
			;
			\path (A)--(D)--([turn]90:0.4) coordinate (xt)
			($(A)-(D)+(xt)$) coordinate (yt);
			\draw[dash pattern=on 2pt off 2pt] (A)--(yt) (D)--(xt);
			\draw[>=stealth,|<->|] (xt)--(yt) node[fill=white,inner sep=0pt,font=\scriptsize,midway,sloped]{$12\ \mathrm{m}$};
			\path (A)--(B)--([turn]90:0.35) coordinate (xt)
			($(A)-(B)+(xt)$) coordinate (yt);
			\draw[dash pattern=on 2pt off 2pt] (A)--(yt) (B)--(xt);
			\draw[>=stealth,|<->|] (xt)--(yt) node[fill=white,inner sep=0pt,font=\scriptsize,midway,sloped]{$8\ \mathrm{m}$};
			\path (A)--(t)--([turn]90:2) coordinate (xt)
			($(A)-(t)+(xt)$) coordinate (yt);
			\draw[dash pattern=on 2pt off 2pt] (A)--(yt) (t)--(xt);
			\draw[>=stealth,|<->|] (xt)--(yt) node[fill=white,inner sep=0pt,font=\scriptsize,midway,sloped]{$50\ \mathrm{m}$};
			\path (N)--(M)--([turn]90:0.5) coordinate (xt)
			($(N)-(M)+(xt)$) coordinate (yt);
			\draw[dash pattern=on 2pt off 2pt] (N)--(yt) (M)--(xt);
			\draw[>=stealth,|<->|] (xt)--(yt) node[fill=white,inner sep=0pt,font=\scriptsize,midway]{$6\ \mathrm{m}$};
			\path (M)--(t)--([turn]90:0.5) coordinate (xt)
			($(M)-(t)+(xt)$) coordinate (yt);
			\draw[dash pattern=on 2pt off 2pt] (M)--(yt) (t)--(xt);
			\draw[>=stealth,|<->|] (xt)--(yt) node[fill=white,inner sep=0pt,font=\scriptsize,midway]{$4\ \mathrm{m}$};
			\draw[->] (B)--(x);
			\draw[->] (D)--(y);
			\draw[->] (Cz)--(z);
			\foreach \x/\g/\n in {B/180/B,D/-60/D
				,A/50/A,C/-90/C,N/0/N,M/0/M,t/0/t,P/180/P,K/0/K}
			\fill (\x) circle (1pt)
			+(\g:2mm) node[scale =1]{\n};
		\end{tikzpicture}
	}
	\choiceTF
	{\True Tọa độ của điểm $N$ là $(0;0;40)$}
	{\True Sau $10$ phút, kiến vàng ở vị trí $K$ với $CK=30$ m}
	{Sau $10$ phút, kiến đen ở vị trí $P$ với $BP=24$ m}
	{Sau $10$ phút, kiến vàng và kiến đen cách nhaukhoảng $6{,}93$ m}
	\loigiai{
		Ta có $ A(0;0;0) $, $ B(8;0;0)$, $C(8;12;0) $, và $D(0;12;0)$.
		\begin{itemchoice}
			\itemch  \textbf{Đúng}. \\		
			$AN=50-6-4=40$ m. Suy ra $N(0;0;40)$.
			\itemch  \textbf{Đúng}. \\
			Ta có $AM=50-4=46$ m. Suy ra $M(0;0;46)$.\\
			$\vec{CM}=(-8;-12;46)$.\\
			Sau $10$ phút, kiến vàng leo được $s = 10 \cdot 3 = 30$ m.	Suy ra $CK=30$ m.		
			\itemch  \textbf{Sai}. \\
			Ta có $\vec{BN}=(-8;0;40)$.\\
			Sau $10$ phút, kiến đen leo được $s = 2{,}5 \cdot 10 = 25$ m. Suy ra $BP=25$ m.
			\itemch  \textbf{Sai}. \\
			Sau $10$ phút, kiến vàng và kiến đen cách nhau $KP$.\\
			Đường thẳng $CM$ qua $C(8;12;0)$ và có vectơ chỉ phương $\vec{CM}=(-8;-12;46)$.\\
			Ta có $CM\colon \heva{&x=8-8t\\&y=12-12t\\&z=46t.} $\\
			Ta có $K\in CM\Rightarrow K(8-8t;12-12t;46t)$.\\
			$CK=30\Leftrightarrow (8t)^2+(12t)^2+(46t)^2=900\Leftrightarrow 2324t^2=900\Leftrightarrow \hoac{&t=\sqrt{\dfrac{225}{581}}\\&t=-\sqrt{\dfrac{225}{581}} \text{ (loại)}.}$\\
			Suy ra $K\left(8- 8\cdot\sqrt{\dfrac{225}{581}};12-12\cdot\sqrt{\dfrac{225}{581}};46\cdot\sqrt{\dfrac{225}{581}}\right)$.\\
			Đường thẳng $BN$ qua $B(8;0;0)$ và có vectơ chỉ phương $\vec{BN}=(-8;0;40)$.\\
			Ta có $BN\colon \heva{&x=8-8t\\&y=0\\&z=40t.} $\\
			Ta có $P\in BN\Rightarrow P(8-8t;0;40t)$.\\
			$BP=25\Leftrightarrow (8t)^2+0^2+(40t)^2=625\Leftrightarrow 1664t^2=625\Leftrightarrow \hoac{&t=\sqrt{\dfrac{625}{1664}}\\&t=-\sqrt{\dfrac{625}{1664}}\text{ (loại)}.}$\\
			Suy ra $P\left(8- 8\cdot\sqrt{\dfrac{625}{1664}};0;40\cdot\sqrt{\dfrac{625}{1664}}\right)$.\\
			Khi đó 
			\allowdisplaybreaks
			\begin{eqnarray*}
				KP&=&\sqrt{\left(8\sqrt{\dfrac{625}{581}}-8\sqrt{\dfrac{625}{1664}}\right)^2+\left(12\sqrt{\dfrac{225}{581}}-12\right)^2+\left(40\sqrt{\dfrac{625}{1664}}-46\sqrt{\dfrac{225}{581}}\right)^2}
				\\
				&\approx& 6{,}12 \text{m}.
			\end{eqnarray*}
		\end{itemchoice}
