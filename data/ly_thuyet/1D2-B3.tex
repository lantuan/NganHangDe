...
\boxminitt{${{u}_{n+1}}={{u}_n}q$ với $n\in \mathbb{N}^*$.}
\begin{gachsoc}
	\begin{itemize}
...
\begin{itemize}
	\item [$\bullet$] Nếu $q \ne 1$ thì \boxminitt{$S_n=\dfrac{u_1\left(1-q^n\right)}{1-q}.$}
...
\begin{baitap}%[Thi thử, Yên Phong số 1 – Bắc Ninh, 2019]%[Đặng Văn Khuyến, 12EX7]%[1D3K4-7]%
...
\begin{baitap}%[THPTQG 2020 đợt 2 - Mã đề 101]%[Trần Nhân Kiệt]%[2D2K4-5]
...
\end{baitap}\cham{7}
\begin{baitap}%[Nguyễn Bình Nguyên]%[1D3T4]
