...
\begin{dang} {Bài toán tìm max, min của hàm số $y=f(x)$ trên miền $\mathscr{D}$}
	\begin{enumerate}[\iconMT]
		...
		\begin{listEX}[1]
			...
			\item [\ding{175}] Gọi $M$, $n$ lần lượt là số lớn nhất và số nhỏ nhất của các kết quả tính toán ở bước ($\star$) thì \quad
...
\begin{vd}
	...
	\begin{tasks}(2)
		\task $f(x)=\dfrac{x^3}{3}-2x^2+3x+1$ trên $[-3;2]$.
		\task $f(x) = - 2x^4 + 4x^2 + 3$ trên $\left[0;2\right]$
...
\begin{vd}
	...
	\begin{tasks}(2)
		\task $y=x-\sin 2x$ trên $\left[-\dfrac{\pi}{2};\pi\right]$
		\task $y = \mathrm{e}^{x^3 - 3x + 3}$ trên $[0; 2]$
		\task $y=\mathrm{e}^{x}(x^{2}-3)$ trên $[-2;2]$
		\task $y=\dfrac{\ln^2x}{x}$ trên $\left[1;\mathrm{e}^5\right]$
	\end{tasks}
	\loigiai{
		\begin{enumerate}[a)]
			\item Ta có
...
\begin{ex}
	\immini[thm]{Hình bên cho biết sự thay đổi của nhiệt độ ở một thành phố trong một ngày. Xét tính đúng, sai của các khẳng định sau:
		\choiceTF
	...
	}{\begin{tikzpicture}[>=stealth,x=0.25cm,y=0.12cm]
...
\cham{1}
\begin{ex}
	Cho hàm số $y=\dfrac{3 x - 4}{x - 6}$. Xét tính đúng-sai của các khẳng định sau:
	\choiceTF
	{ Tập xác định của hàm số là $(6;+\infty)$}
	{ \True $y(0)=\dfrac{2}{3}$ }
	{ $y'>0$ với mọi $x\ne 6$ }
	{ \True $\min\limits_{[0;2]}{y}=- \dfrac{1}{2}$}
	\loigiai{ 
		
		
		a) Điều kiện xác định $x \ne 6$ nên tập xác định là $\mathbb{R}\backslash\{6\}$. Khẳng định đã cho là khẳng định sai.
			
		b) Khẳng định đã cho là khẳng định đúng.
		
		$y=\frac{3 x - 4}{x - 6}\Rightarrow y(0)= \frac{2}{3}$.
		
		c) Khẳng định đã cho là khẳng định sai.
		
		$y'=\dfrac{-14}{(x - 6)^2}\Rightarrow y'<0$ với mọi $x\ne 6$.
		
		d) Khẳng định đã cho là khẳng định đúng.
		
		$y'=\dfrac{-14}{(x - 6)^2}>0, \forall x \ne 6$.
		
		$y(0)=\frac{2}{3}, y(2)=- \frac{1}{2}$.
		
		Hàm số nghịch biến trên khoảng $(0;2)$.
		
		Do đó: $\mathop{\min}\limits_{[0;2]} {y}=- \frac{1}{2}$.
...
\cham{9}
\begin{ex}
	Cho hàm số $y=- \dfrac{x^{3}}{3} - x^{2} + 3$. Xét tính đúng-sai của các khẳng định sau:
	\choiceTF
	{ $y'=- x^{2} - 4 x$ }
	{ \True $y'=0$ khi $x=-2,x=0$ }
	{ \True $y(0)=3$ }
	{ \True $\min\limits_{[-6;4]}{y}=- \dfrac{103}{3}$}
	\loigiai{ 
		
		
		a) Khẳng định đã cho là khẳng định sai.
		
		$y=- \frac{x^{3}}{3} - x^{2} + 3 \Rightarrow y'=- x^{2} - 2 x$.
		
		b) Khẳng định đã cho là khẳng định đúng.
		
		$y'=- x^{2} - 2 x\Rightarrow y'=0$ khi $x=-2,x=0$.
		
		c) Khẳng định đã cho là khẳng định đúng.
		
		$y=- \frac{x^{3}}{3} - x^{2} + 3\Rightarrow y(0)= 3$.
		
		d) Khẳng định đã cho là khẳng định đúng.
		
		$y(-6)=39, y(-2)=\frac{5}{3}, y(0)=3, y(4)=- \frac{103}{3}$.
		
		Do đó: $\mathop{\min}\limits_{[-6;4]} {y}=- \frac{103}{3}$.
