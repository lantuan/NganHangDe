...
Phuơng sai của mẫu số liệu ghép nhóm, kí hiệu $S^2$, được tính bởi công thức
\boxmini{$S^2=\dfrac{1}{n}\left[n_1\left(c_1-\overline{x}\right)^2+n_2\left(c_2-\overline{x}\right)^2+\cdots+n_k\left(c_k-\overline{x}\right)^2\right]$}
Trong đó: 
\begin{itemize}
	\item [\iconCH] $n=n_1+n_2+\cdots+n_k$ là cỡ mẫu;
	\item [\iconCH] $\overline{x}=\dfrac{1}{n}\left(n_1 c_1+n_2 c_2+\cdots+n_k c_k\right)$ là số trung bình.
\end{itemize}
...
\boxmini{$\overline{x}=\dfrac{1}{n}\left(n_1 c_1+n_2 c_2+\cdots+n_k c_k\right)$}
\end{dang}
